        ...
        child: Form(
          child: ListView(
            ...
            children: [
              ...
              Text(
                verifyYourAccountText.toTitleCase(),
                style: TextStyle(
                    color: Colors.black,
            ...
            /*  SizedBox(
             ...
             /* OtpPinField(
                key: _otpPinFieldEmailController,
  ...
  void verifyOtpApi() {
    try {
      Map<String, String> params = {
       ...
       "phone_otp":"12345",
      // "email_otp": _otpPinFieldEmailController.currentState!.text
      ...
      switch (requestCode) {
        ...
        case verifyOtpUrlRequest:
          ...
          commonErrorDialogDialog(
              MediaQuery.of(context).size, errorMessage, map["code"].toString(),
              () {
            Navigator.pop(context);
          });
      ...
      switch (requestCode) {
        ...
        case registerUrlRequest:
          ...
          if (map["code"] == 200) {
            ...
            /*sharedPreferences!.setString(
                profileImageKey, map["response"]["user"][profileImageKey]);*/
