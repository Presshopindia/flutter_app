                    ...
                    children: [
                      !rememberMe? Padding(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                              color: Colors.black, fontSize: size.width * numD035,fontWeight: FontWeight.bold),
                        ),
                      ):Container(),
                      /*   SizedBox(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  "I have read and agree to PRESSHOP’s terms & conditions as set out in the user agreement.",
                  style: commonTextStyle(
                      size: size,
                      fontSize: size.width * numD035,
                      color: Colors.black,
          ...
          Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  "I have read and agree to PRESSHOP’s privacy policy.",
                  style: commonTextStyle(
                      size: size,
                      fontSize: size.width * numD035,
                      color: Colors.black,
          ...
          Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  " By uploading Content on PRESSHOP’s app and platform, you are warranting that you own all proprietary rights, or are the authorised representative of the applicable copyright owner(s) of such Content, including copyright.",
                  style: commonTextStyle(
                      size: size,
                      fontSize: size.width * numD035,
                      color: Colors.black,
          ...
          Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  "By using PRESSHOP’s app and platform, you warrant that you are 18 years of age or older, and have the legal authority to enter into these Terms.",
                  style: commonTextStyle(
                      size: size,
                      fontSize: size.width * numD035,
                      color: Colors.black,
          ...
          Expanded(
            ...
            child: commonElevatedButton(
              ...
              if (check1Value && check2Value && check3Value && check4Value) {
                ...
                showSnackBar("Error", "Please select all check box",Colors.red);
              }
            }),
          )),
        ],
