...
class CustomGalleryState extends State<CustomGallery> {
                      ...
                      _mediaList[index].originFile.then((value) async {
                        ...
                        if (_mediaList[index].type == AssetType.video) {
                          ...
                          if(value.absolute.path.contains(".HEIC")){
                            ...
                            convertHEICToJPEG(value.absolute.path,_mediaList[index].width,_mediaList[index].height).then((imgValue) {
                    ...
                    children: <Widget>[
                      ...
                      Positioned.fill(
                          child: Image(image: AssetEntityImageProvider(
                            _mediaList[index], isOriginal: false,
  ...
  Future<void> getMedia() async {
    ...
    if (result.isAuth) {
      ...
      if (paths.isNotEmpty) {
        ...
        List<AssetEntity> media = await _path!.getAssetListPaged(
            page: page, size: _sizePerPage);
        _mediaList = media;
  ...
  Future<String> convertHEICToJPEG(String path,int width,int height) async {
    try {
      ...
      var result = await fic.FlutterImageCompress.compressWithFile(
        path,
        quality: 95,
