...
class TutorialsScreenState extends State<TutorialsScreen>
  ...
  List<TutorialsData> searchResult = [];
                        ...
                        itemBuilder: (context, index) {
                          return InkWell(
                            ...
                            child: Chip(
                              ...
                              label: Text(
                                categoryList[index].name.toCapitalized(),
                                style: TextStyle(
    ...
    try {
      switch (requestCode) {
        case getAllCmsUrlRequest:
          ...
          var listModel = data["status"] as List;
        var  tutorialData =
              listModel.map((e) => TutorialsData.fromJson(e)).toList();
          tutorialsList.clear();
...
class TutorialsData {
  ...
  factory TutorialsData.fromJson(Map<String, dynamic> json) {
