              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Image.asset( "${iconsPath}ic_exclusive.png",
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  hintStyle:
                                  TextStyle(color: Colors.black, fontSize: size.width * numD04),
                          ...
                          Row(
                            ...
                            children: [
                              Image.asset("${iconsPath}ic_tag.png",height: size.width*numD06,),
                              ...
                              Stack(
                                children: [
                                  SizedBox(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintStyle:
                                        TextStyle(color: Colors.grey.shade400, fontSize: size.width * numD035),
                                        disabledBorder: OutlineInputBorder(
                                            borderRadius: BorderRadius.circular(size.width * 0.03),
                                            borderSide:
                                            const BorderSide(width: 1, color: Colors.black)),
                                  ...
                                  Padding(
                                    ...
                                    child: Icon(Icons.sticky_note_2_outlined,size: size.width*numD06,color: Colors.grey.shade400,),
                                  ),
