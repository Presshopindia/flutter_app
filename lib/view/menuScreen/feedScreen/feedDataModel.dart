...
class FeedsDataModel {
  ...
  factory FeedsDataModel.fromJson(Map<String, dynamic> json) {
    ...
    return FeedsDataModel(
      ...
      timestamp: changeDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'",
          json["timestamp"], "HH:mm, dd MMM, yyyy"),
      contentDataList: contentData,
      createdAt: changeDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'",
          json['createdAt'], "HH:mm, dd MMM, yyyy"),
      updatedAt: changeDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'",
          json['updatedAt'], "HH:mm, dd MMM, yyyy"),
      heading: json["heading"] ?? "",
      remarks: json["remarks"] ?? "",
      userId: json["user_id"] ?? "",
