                          ...
                          SizedBox(
                            ...
                            child: PageView.builder(
                                ...
                                itemBuilder: (context, idx) {
                                  var item =
                                      feedDataList[index].contentDataList[idx];
                                  return ClipRRect(
                                            ...
                                            child: Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                child:
                                                    feedDataList[index].isEmoji
                                                        ? Image.asset(
                                                            "${iconsPath}sad_emoji.png",
                                                            height: size.width *
                                                                numD0568,
                                                          )
                                                        : Image.asset(
                                                            "${iconsPath}emoji_icon.png",
                                                            height: size.width *
                                                                numD0568,
                                                          ),
                                              ),
        ...
        return InkWell(
          onTap: () {
            /*if (isSort) {
              ...
              if (item.isSelected) {
                if (item.name == viewWeeklyText) {
                  callFilterListAPI();
                } else if (item.name == viewMonthlyText) {
                  callFilterListAPI();
                } else if (item.name == viewYearlyText) {
                  callFilterListAPI();
                }
              }
            }
              ...
              item.isSelected = true;
              if (item.isSelected) {
                if (item.name == allExclusiveContentText) {
                  callFilterListAPI();
                } else if (item.name == allSharedContentText) {
                  callFilterListAPI();
                } else if (item.name == paymentsReceivedText) {
                  callFilterListAPI();
                } else if (item.name == pendingPaymentsText) {
                  callFilterListAPI();
                }
              }
            }*/
