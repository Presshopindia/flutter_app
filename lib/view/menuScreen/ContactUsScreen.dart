                      ...
                      child: InkWell(
                        ...
                        child: Text(
                          ...
                          style: commonTextStyle(
                            ...
                            fontSize: size.width * numD033,
                            color: colorThemePink,
                            fontWeight: FontWeight.w500, // Set fontWeight to the desired value
                          ),
                        ),
                      ),
                    ),
                      ...
                      InkWell(
                        onTap: () async {
                          Uri linkedUrl = Uri.parse(
                            ...
                            //  'https://www.linkedin.com/company/79070111/admin/feed/posts/');
  ...
  void onResponse({required int requestCode, required String response}) {
    try {
      switch (requestCode) {
        case reqContactUSAPI:
          debugPrint(
              "reqContactUSAPI_Response ==> ${jsonDecode(response)}");
          /*showSnackBar(
              'Presshop', contactUsSubmitMessage, Colors.black);*/
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => ChatListingScreen(
        ...
        case reqAdminDetailAPI:
          debugPrint(
              "reqAdminDetailAPI_Response ==> ${jsonDecode(response)}");
