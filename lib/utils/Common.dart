...
const reqGetPublicationTransactionAPI =49;
...
const walk3ButtonText = "Sell your pic now";
...
const walk4ButtonText = "Start accepting task";
...
const bankErrorText = "Please enter a valid account number";
...
const addBankDetailsSubHeadingText =
    "Please add your bank details where you wish to receive your funds. Your details are safe with us";
...
const uploadDocsSubHeading1Text =
    "If you're a professional photographer, and want to sign up as a";
...
const amountPendingText = "Amount pending";
    ...
    try{
        if(value.length==1){
            ...
            if(decimalFormatting.contains(".")){
                ...
                return int.parse(decimalFormatting);
            }
...
String dateTimeFormatter({required String dateTime,String format = "d MMMM yyyy", bool time = false, bool utc = false}) {
