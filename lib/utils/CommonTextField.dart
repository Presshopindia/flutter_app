...
class CommonTextFieldState extends State<CommonTextField> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      style: TextStyle(color: Colors.black, fontSize: widget.size.width * numD032,fontFamily: 'AirbnbCereal_W_Md'),
      ...
      decoration: InputDecoration(
        counterText: "",
          ...
          hintStyle:
              TextStyle(color: colorHint, fontSize: widget.size.width * numD035,fontFamily: 'AirbnbCereal_W_Md'),
